						...
						<div class="row">
							...
							<div class="col-sm-7">
								<div class="about-us-box">
									...
									<p>We do not compromise on best quality transportation services, this is our top priority. We are committed to delivering the highest quality services that comply with international safety and quality standards.</p>
									<div class="row">
										<div class="col-sm-6">
											<div class="about-us-post">
												<a href="#"><i class="fa fa-dropbox"></i></a>
												<h2>Transport</h2>
												<span>We always deliver</span>
											</div>
							...
							<div class="col-sm-5">
								...
								<div class="about-box">
									<h2>Who we are</h2>
									<p>Established in year 2022 as an independent B-BBEE LEVEL 1 transportation service provider, <?php echo $site_title ?> will deliver an excellent and unbeatable transportation services at competitive prices.</p>
								</div>
				...
				<section class="clients-section">
					<div class="container">
						<div class="row">
							...
							<div class="col-sm-6">
								<blockquote>
									<p>These are some of <span>our partners</span> and <span>customers</span>, who are very satisfied with our work. <br>Do you want to be <span>next one</span> ?</p>
								</blockquote>
							</div>
						</div>
